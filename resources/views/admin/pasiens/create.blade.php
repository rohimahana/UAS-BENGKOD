    ...
    <div class="p-4 sm:p-6">
        <div class="mx-auto max-w-4xl">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Tambah Pasien</h1>
                    <p class="mt-1 text-sm text-slate-600">
                        Buat akun pasien untuk akses pendaftaran dan riwayat pemeriksaan.
                    </p>
                </div>
            ...
            <div class="mt-6 rounded-3xl border border-slate-200 bg-white shadow-sm">
                <form action="{{ route('admin.pasien.store') }}" method="POST" id="pasienForm">
                    @csrf
                    ...
                    <div class="border-b border-slate-200 p-5">
                        ...
                        <p class="mt-1 text-sm text-slate-600">Gunakan email aktif untuk akses login pasien.</p>
                    </div>
                    ...
                    <div class="border-t border-slate-200 p-5">
                        ...
                        <p class="mt-1 text-sm text-slate-600">Buat password awal untuk pasien.</p>
                    ...
                    <div class="flex flex-col-reverse gap-3 border-t border-slate-200 p-5 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <button type="button"
                                ...
                                onclick="confirmSubmit('#pasienForm', 'Simpan pasien baru?', 'Data pasien akan dibuat dan bisa digunakan untuk login.')">
