<x-layouts.app title="Tambah Jadwal Periksa">
    <div class="mx-auto max-w-3xl px-4 py-6">
        <div class="flex items-start justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-slate-900">Tambah Jadwal Periksa</h1>
                <p class="mt-1 text-sm text-slate-600">Atur hari dan jam praktik. Status dapat diubah kapan saja.</p>
            </div>
        ...
        <div class="mt-6 rounded-3xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 px-6 py-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="text-sm font-semibold">Form Jadwal</div>
            ...
            <div class="p-6">
                ...
                <form action="{{ route('dokter.jadwal-periksa.store') }}" method="POST" class="space-y-4">
                    @csrf
